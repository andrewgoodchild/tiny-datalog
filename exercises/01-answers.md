...
wrong *logically* — the rules say exactly this — which is the lesson:
read what a rule really says.
...
see the README's "Deliberately missing" section for why the engine
