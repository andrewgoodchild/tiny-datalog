...
gap between the result and its image. *(Lesson 4)*
...
cases in this course are the graphs that are *not* acyclic. *(Lesson 6)*
...
least model is exactly M. *(Lesson 4)*
...
are actually demanded. *(Lesson 5)*
...
is genuinely circular. *(Lesson 4)*
